<script>
  ...
  let subhed = `
    ...
    Leonardo is a 2024 recipient of the <a href="https://www.sigmaawards.org/meet-the-winners-of-the-sigmas-2024-for-data-journalism/" target=__blank>Sigma Award</a>, recognizing the best data journalism from around the world, and the <a href="https://awards.journalists.org/entries/uncovering-bias-in-two-leading-ai-systems/" target=__blank>Online Journalism Awards (OJAs)</a>, recognizing Excellence in Technology Reporting, for his work on Generative AI Bias.</p>
  `;
